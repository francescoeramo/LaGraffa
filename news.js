// Generato automaticamente il 2026-07-21 15:08 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1784646486;
...
const NEWS = [
  {
    id: 1,
    cat: "politica-italiana",
    title: "Lady Brexit 'uccisa con 21 colpi di martello alla testa'",
    summary: "Lo riferisce pubblico ministero in udienza dove è comparso il 28enne accusato di omicidio",
    body: "Lo riferisce pubblico ministero in udienza dove è comparso il 28enne accusato di omicidio",
    source: "ANSA",
    url: "https://www.ansa.it/sito/notizie/mondo/europa/2026/07/21/uccisione-di-lady-brexit-massacrata-con-21-colpi-di-martello-alla-testa_3ec8ef21-e964-456d-ac28-0f6090f19ac2.html",
    time: "1 ora fa",
    pub_ts: 1784642828,
    tags: [],
  },
  {
    id: 2,
    cat: "politica-italiana",
    title: "L'annuncio di Daniel Ortega: 'In Nicaragua non ci saranno più elezioni'",
    summary: "Il sandinista al potere dal 2007: 'Basta ai partiti sostenuti dagli yankee'",
    body: "Il sandinista al potere dal 2007: 'Basta ai partiti sostenuti dagli yankee'",
    source: "ANSA",
    url: "https://www.ansa.it/sito/notizie/mondo/2026/07/21/lannuncio-di-daniel-ortega-in-nicaragua-non-ci-saranno-piu-elezioni_2ff46008-bb64-4295-a6d7-4e40c864a09c.html",
    time: "4 ore fa",
    pub_ts: 1784631078,
    tags: [],
  },
  ...
  },
  {
    ...
    body: "Israeli forces launch regular attacks on Gaza despite a US-backed 'ceasefire' agreed in October.",
    source: "Al Jazeera",
  ...
  },
  {
    ...
    body: "Southeast Asian countries are highly affected by oil supply shortages caused by Iran war and Strait of Hormuz closure.",
    source: "Al Jazeera",
  ...
  },
  {
    ...
    body: "Yields on 10-year US Treasury bills, a bellwether for inflation, are up 60 basis points since the start of the Iran war.",
    source: "Al Jazeera",
  ...
  },
  {
    ...
    body: "People visit the booth of Kimi, an LLM developed by the Chinese startup Moonshot, during the World AI Conference in Shanghai, China, Monday, July 20, 2026. | Image: LONG WEI/ Feature China/Future Publishing via Getty Images Last week, two Chinese AI companies unveiled models they say can credibly compete with the best systems from OpenAI and Anthropic. The response was swift and predictable. Markets wobbled , commentators declared Silicon Valley shooketh, and policymakers reached for the familiar language of arms races and wake-up calls.\n\nIn one headline, The Associated Press said a Chinese model had taken the \"US tech industry by surprise.\" Bloomberg described it as a \"surprise breakthrough\" that is \" roiling markets \" and sending global tech stocks tumbling over concerns it could force US firms to rethink their gargantuan spending on data centers, chips, and ot …",
    source: "The Verge",
  ...
  },
  {
    ...
    body: "The final approval settles one case, but it doesn't resolve the broader issue of using copyrighted works to train AI models.",
    source: "TechCrunch",
  ...
  },
  {
    id: 15,
    cat: "economia-tech",
    title: "Omr vara il bilancio socialee non esclude la Borsa",
    summary: "Primo report Esg del gruppo che anticipa gli standard europei di rendicontazione - Nel 2025 ricavi a 529 milioni ed Ebitda record di 58 milioni",
    body: "Primo report Esg del gruppo che anticipa gli standard europei di rendicontazione - Nel 2025 ricavi a 529 milioni ed Ebitda record di 58 milioni",
    source: "Il Sole 24 Ore",
    url: "https://www.ilsole24ore.com/art/omr-vara-bilancio-socialee-non-esclude-borsa-AJWnjNQ",
    time: "11 ore fa",
    pub_ts: 1784606648,
    tags: [],
  },
  ...
  },
  {
    ...
    summary: "US president to renew trade war after Supreme Court threw out reciprocal duties",
    body: "US president to renew trade war after Supreme Court threw out reciprocal duties",
  ...
  },
  {
    ...
    summary: "Washington accuses neighbour of engaging in unfair practices in move that could reignite trade war",
    body: "Washington accuses neighbour of engaging in unfair practices in move that could reignite trade war",
    source: "Financial Times",
    url: "https://www.ft.com/content/0b507e93-877f-4cf7-904b-639eb390c4bf?syn-25a6b1a6=1",
    time: "14 ore fa",
    pub_ts: 1784593009,
    tags: [],
  },
