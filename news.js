// Generato automaticamente il 2026-08-01 00:05 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1785542706;
...
const NEWS = [
  ...
  },
  {
    id: 11,
    cat: "conflitti",
    title: "Iran war live: Iran says it has a plan to respond to any US attacks",
    summary: "An Iranian official quoted by Tasnim says comprehensive plans are in place to respond to any 'mad' US strikes.",
    body: "An Iranian official quoted by Tasnim says comprehensive plans are in place to respond to any 'mad' US strikes.",
    source: "Al Jazeera",
  ...
  },
  {
    id: 21,
    cat: "economia-tech",
    title: "Fifa backs down from controversial $20bn investment plan",
    summary: "Gianni Infantino says it was ‘clear’ the project created divisions that are no longer in the interest of the body’s initial objective",
    body: "Gianni Infantino says it was ‘clear’ the project created divisions that are no longer in the interest of the body’s initial objective",
    source: "Financial Times",
