// Generato automaticamente il 2026-07-22 20:15 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1784751322;
...
const NEWS = [
  ...
  },
  {
    ...
    summary: "The newly appointed leader says Hamas would work to help the people of Gaza and achieve a united Palestinian state.",
    body: "The newly appointed leader says Hamas would work to help the people of Gaza and achieve a united Palestinian state.",
    source: "Al Jazeera",
    url: "https://www.aljazeera.com/news/2026/7/22/key-takeaways-from-khalil-al-hayyas-first-speech-as-hamas-leader?traffic_source=rss",
    time: "1 ora fa",
    pub_ts: 1784745831,
    tags: [],
  },
  ...
  },
  {
    id: 18,
    cat: "economia-tech",
    title: "OpenAI’s Brockman on New ChatGPT Era After ‘Tough’ Year of Cuts: Q&A",
    summary: "The AI startup has combined its products into a so-called super app.",
    body: "The AI startup has combined its products into a so-called super app.",
  ...
  },
  {
    id: 19,
    cat: "economia-tech",
    title: "‘Golden Age’ Dawns for Technology IPOs, Barclays Banker Says",
    summary: "The market for initial public offerings in the technology sector is entering what Barclays’ Jamie Turturici, head of TMT equity capital markets, called “a golden age” as a slew of companies head for public markets.",
    body: "The market for initial public offerings in the technology sector is entering what Barclays’ Jamie Turturici, head of TMT equity capital markets, called “a golden age” as a slew of companies head for public markets.",
    source: "Bloomberg Tech",
