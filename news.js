// Generato automaticamente il 2026-07-15 12:20 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1784118032;
...
const NEWS = [
  {
    id: 1,
    cat: "politica-italiana",
    title: "Legge elettorale, Meloni: 'Continuiamo a mantenere l'impegno'. Ciriani: 'Il governo non si ferma'",
  ...
  },
  {
    id: 8,
    cat: "geopolitica",
    title: "La economía china frena al 4,3% por la debilidad del consumo y la crisis inmobiliaria",
    summary: "El crecimiento del PIB del segundo trimestre, el más bajo desde finales de 2022, queda por debajo de las previsiones pese al auge exportador del gigante asiático",
    body: "La economía de China perdió impulso durante el segundo trimestre de 2026, según ha revelado este miércoles la Oficina Nacional de Estadísticas (ONE). El Producto Interior Bruto (PIB) de la segunda economía del planeta aumentó un 4,3% interanual entre abril y junio, siete décimas por debajo del 5% registrado en los tres primeros meses del año . Seguir leyendo",
    source: "El Pais",
    url: "https://elpais.com/economia/2026-07-15/la-economia-china-frena-al-43-por-la-debilidad-del-consumo-y-la-crisis-inmobiliaria.html",
    time: "5 ore fa",
    pub_ts: 1784098447,
    tags: [],
  },
  ...
  },
  {
    ...
    summary: "At least three people killed and three others wounded in Russian strikes on Odesa, city's military administrator says.",
    body: "At least three people killed and three others wounded in Russian strikes on Odesa, city's military administrator says.",
    source: "Al Jazeera",
    url: "https://www.aljazeera.com/news/2026/7/15/russian-attack-on-odesa-kills-three-as-ukraine-targets-vessels-in-black-sea?traffic_source=rss",
    time: "3 ore fa",
    pub_ts: 1784105740,
    tags: [],
  },
  ...
  },
  {
    ...
    summary: "Investment bank becomes latest to shatter forecasts with revenues from equities trading",
    body: "Investment bank becomes latest to shatter forecasts with revenues from equities trading",
    source: "Financial Times",
