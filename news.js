// Generato automaticamente il 2026-07-21 17:35 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1784655333;
...
const NEWS = [
  ...
  },
  {
    id: 2,
    cat: "politica-italiana",
    title: "Meloni: 'A Bologna fatto inaccettabile'. Lepore: 'chiedere la verità non delegittima le divise'",
    summary: "La premier dopo la morte di Fakir e gli scontri: 'Irresponsabile alimentare un clima di odio verso un Corpo dello Stato'",
    body: "La premier dopo la morte di Fakir e gli scontri: 'Irresponsabile alimentare un clima di odio verso un Corpo dello Stato'",
    source: "ANSA",
  ...
  },
  {
    ...
    body: "Google is launching Gemini 3.6 Flash alongside a new security model dedicated to quickly finding and patching security vulnerabilities. In a blog post on Tuesday , Google describes Gemini 3.5 Flash Cyber as a \"cost-efficient and highly capable alternative\" to larger, more expensive AI systems, such as the one offered by Anthropic's Mythos. The cybersecurity model is built upon Gemini 3.5 Flash and will be available first to governments and trusted partners via CodeMender, Google's security-focused coding agent .\n\nAs noted by Google, CodeMender can call upon 3.5 Flash Cyber \"multiple times at high speed and low cost,\" allowing the AI agents to …",
    source: "The Verge",
