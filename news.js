// Generato automaticamente il 2026-07-15 22:07 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1784153235;
...
const NEWS = [
  ...
  },
  {
    ...
    summary: "Emergent, a startup that helps small businesses build applications using artificial intelligence, has raised $130 million in a round that makes the company one of the few Indian AI startups to hit a unicorn valuation.",
    body: "Emergent, a startup that helps small businesses build applications using artificial intelligence, has raised $130 million in a round that makes the company one of the few Indian AI startups to hit a unicorn valuation.",
    source: "Bloomberg Tech",
    url: "https://www.bloomberg.com/news/articles/2026-07-15/indian-ai-startup-emergent-valued-at-1-5-billion-in-fundraising",
    time: "10 ore fa",
    pub_ts: 1784117040,
    tags: [],
  },
