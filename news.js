// Generato automaticamente il 2026-07-27 23:10 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1785193836;
...
const NEWS = [
  ...
  },
  {
    ...
    source: "El Pais",
    url: "https://elpais.com/argentina/2026-07-27/brasil-llama-a-consultas-al-embajador-argentino-tras-ataques-de-milei-contra-lula.html",
    time: "22 ore fa",
    pub_ts: 1785112044,
    tags: [],
  },
  {
    ...
    body: "Will Britain's new cabinet change the country’s role in Israel’s war on Gaza?",
    source: "Al Jazeera",
  ...
  },
  {
    ...
    body: "Mediators from Qatar and Pakistan work to restart ceasefire talks amid fragile pause in hostilities.",
    source: "Al Jazeera",
  ...
  },
  {
    ...
    body: "Unreleased documentary footage shows late US Senator Lindsey Graham celebrating the war on Iran.",
    source: "Al Jazeera",
  ...
  },
  {
    ...
    body: "The issue appears to have originated from Claude’s “share chat” feature, which allows users to create links that enable anyone with the assigned URL view a conversation or project.",
    source: "TechCrunch",
  ...
  },
  {
    ...
    summary: "Angola has raised 300.3 billion kwanzas ($321 million) through the sale of 15% stake in state-owned wireless operator Unitel SA, marking the southwest African nation’s biggest initial public offering.",
    body: "Angola has raised 300.3 billion kwanzas ($321 million) through the sale of 15% stake in state-owned wireless operator Unitel SA, marking the southwest African nation’s biggest initial public offering.",
