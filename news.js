// Generato automaticamente il 2026-07-17 03:21 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1784258459;
...
const NEWS = [
  ...
  },
  {
    ...
    body: "Iran says US strikes hit bridges in the country in an apparent escalation, while the US boards a ship in the Strait of Hormuz.",
    source: "BBC World",
  ...
  },
  {
    id: 10,
    cat: "geopolitica",
    title: "Trump recibe a Bukele en la Casa Blanca para estrechar la cooperación migratoria y de seguridad",
    summary: "La segunda visita del presidente de El Salvador al Despacho Oval se produce días después de que obtuviera el aval para un tercer mandato",
    body: "El presidente de Estados Unidos, Donald Trump, ha recibido este jueves en la Casa Blanca a uno de sus aliados más preciados en Latinoamérica, el presidente de El Salvador, Nayib Bukele, quien acaba de recibir el aval de su partido para un tercer mandato después de aprobar una reforma legal para eliminar el límite a la reelección. La reunión se celebró a puerta cerrada y la Casa Blanca apenas dio detalles del encuentro más allá de precisar que ambos mandatarios trataron temas relacionados con la inmigración y la seguridad.\n\nSeguir leyendo",
    source: "El Pais",
    url: "https://elpais.com/internacional/2026-07-16/trump-recibe-a-bukele-en-la-casa-blanca-para-estrechar-la-cooperacion-migratoria-y-de-seguridad.html",
    time: "7 ore fa",
    pub_ts: 1784230485,
    tags: [],
  },
  {
    ...
    summary: "Eleven people have died and 19 other have suffered injuries in the overnight fire, the authorities say.",
    body: "Eleven people have died and 19 other have suffered injuries in the overnight fire, the authorities say.",
    source: "BBC World",
  ...
  },
  {
    ...
    summary: "Aide allegedly used advanced knowledge of president’s speeches to profit on ‘mention markets’ wagers",
    body: "Aide allegedly used advanced knowledge of president’s speeches to profit on ‘mention markets’ wagers",
    source: "Financial Times",
