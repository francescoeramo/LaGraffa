// Generato automaticamente il 2026-07-30 20:18 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1785442701;
...
const NEWS = [
  ...
  },
  {
    ...
    body: "A large plume of smoke was seen rising over the southwestern Iranian city of Ahvaz following renewed US strikes.",
    source: "Al Jazeera",
    url: "https://www.aljazeera.com/video/newsfeed/2026/7/30/smoke-rises-over-southern-iran-after-renewed-us-attacks?traffic_source=rss",
    time: "5 ore fa",
    pub_ts: 1785423521,
    tags: [],
  },
  ...
  },
  {
    id: 24,
    cat: "economia-tech",
    title: "DeepSeek Is Developing Massive AI Data Center in Inner Mongolia",
    summary: "China’s DeepSeek is planning a massive artificial-intelligence data center in Inner Mongolia, according to people familiar with the matter, an ambitious move in computing infrastructure from the startup that’s shown it can compete with the leading AI models of Silicon Valley.",
    body: "China’s DeepSeek is planning a massive artificial-intelligence data center in Inner Mongolia, according to people familiar with the matter, an ambitious move in computing infrastructure from the startup that’s shown it can compete with the leading AI models of Silicon Valley.",
    source: "Bloomberg Tech",
    url: "https://www.bloomberg.com/news/articles/2026-07-30/deepseek-is-developing-massive-ai-data-center-in-inner-mongolia",
    time: "1 ora fa",
    pub_ts: 1785436247,
    tags: [],
  },
