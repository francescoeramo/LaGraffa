// Generato automaticamente il 2026-07-26 20:14 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1785096853;
...
const NEWS = [
  ...
  },
  {
    id: 3,
    cat: "geopolitica",
    title: "Guterres alaba la transición en Siria y llama a Israel a respetar su integridad territorial",
    summary: "El secretario general de la ONU visita el país árabe por primera vez y se reúne con el presidente Al Shara",
    body: "En su primera visita a Siria , el secretario general de Naciones Unidas, António Guterres , se ha sumado este domingo al respaldo internacional que en las últimas semanas ha arropado al Gobierno de Damasco. “No tengo duda de que la transición está yendo en la dirección correcta y por eso la comunidad internacional debe apoyar a Siria”, ha dicho Guterres en una rueda de prensa celebrada en el hotel Sheraton de la capital siria entre fuertes medidas de seguridad.\n\nSe cumplen 19 meses desde que el presidente Ahmed al Shara tomara el poder tras poner fin a casi medio siglo de dictadura de la familia El Asad y 14 años de guerra civil. Seguir leyendo",
    source: "El Pais",
    url: "https://elpais.com/internacional/2026-07-26/guterres-alaba-la-transicion-en-siria-y-llama-a-israel-a-respetar-su-integridad-territorial.html",
    time: "1 ora fa",
    pub_ts: 1785090937,
    tags: [],
  },
