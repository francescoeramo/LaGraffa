// Generato automaticamente il 2026-07-20 18:57 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1784573838;
...
const NEWS = [
  ...
  },
  {
    id: 2,
    cat: "politica-italiana",
    title: "'Le blatte' in piazza a New Delhi, la polizia carica gli studenti",
    summary: "Chiedono le dimissioni del ministro dopo i presunti brogli sul test di accesso a Medicina",
    body: "Chiedono le dimissioni del ministro dopo i presunti brogli sul test di accesso a Medicina",
    source: "ANSA",
  ...
  },
  {
    id: 3,
    cat: "politica-italiana",
    title: "New York verso l'addio alle carrozzelle di Central Park",
    summary: "Dopo le tante polemiche e 165 anni di storia pronta la legge per vietarle dal 2028",
    body: "Dopo le tante polemiche e 165 anni di storia pronta la legge per vietarle dal 2028",
    source: "ANSA",
    url: "https://www.ansa.it/sito/notizie/mondo/nordamerica/2026/07/20/new-york-verso-il-divieto-delle-carrozze-a-central-park-fine-di-unera_9417441c-1975-4926-8363-3dfb19eb4f91.html",
    time: "1 ora fa",
    pub_ts: 1784569809,
    tags: [],
  },
  {
    id: 4,
    cat: "politica-italiana",
    title: "Regno Unito, il gatto Larry pronto ad accogliere il nuovo Primo ministro",
    summary: "Andy Burnham sarà il settimo PM a condividere il numero 10 di Downing Street",
    body: "Andy Burnham sarà il settimo PM a condividere il numero 10 di Downing Street",
    source: "ANSA",
    url: "https://www.ansa.it/sito/videogallery/mondo/2026/07/20/regno-unito-il-gatto-larry-pronto-ad-accogliere-il-nuovo-primo-ministro_4780515f-f8dc-4f12-a8ae-cfea175aed18.html",
    time: "3 ore fa",
    pub_ts: 1784559989,
    tags: [],
  },
  ...
  },
  {
    ...
    body: "The Irish airline said oil prices had increased costs meanwhile Brent crude surpassed $90.",
    source: "BBC World",
  ...
  },
  {
    ...
    body: "Implementation of the trilateral framework agreement between Israel, Lebanon and the US is to start in three villages.",
    source: "Al Jazeera",
    url: "https://www.aljazeera.com/news/2026/7/20/lebanons-military-starts-pilot-zone-takeover-in-south?traffic_source=rss",
    time: "2 ore fa",
    pub_ts: 1784564022,
    tags: [],
  },
  {
    ...
    body: "An Iranian army spokesman asserts the war will continue until deterrence against further attacks has been achieved.",
    source: "Al Jazeera",
    url: "https://www.aljazeera.com/news/2026/7/20/iran-says-diplomatic-efforts-ongoing-via-mediators-amid-fighting-with-us?traffic_source=rss",
    time: "2 ore fa",
    pub_ts: 1784563927,
    tags: [],
  },
  {
    ...
    body: "Trump has expressed sadness and vowed to hit Iran 'very hard' to honour killed US soldiers.",
    source: "Al Jazeera",
  ...
  },
  {
    ...
    body: "AI infrastructure company Infinity announced Monday a $15 million raise at a $100 million valuation from investors including Touring Capital, Principal VC, and researchers from companies such as OpenAI and Anthropic.",
    source: "TechCrunch",
  ...
  },
  {
    ...
    body: "Welcome to the “what is a photo” debate, Adobe. | Image: Adobe Adobe's experimental camera app has taken an unexpected turn. After Project Indigo was launched last year to provide a \"more natural (SLR-like) look\" for iPhone photography, the Indigo camera app is now being updated with a suite of generative AI tools. And the change doesn't rely upon Adobe's own Firefly AI models. Adobe describes the new \"AI Playground\" tooling suite as an experiment and says there's a button that allows users to opt out and continue using the app as before.\n\nFree access to the suite with no sign-on requirement is being tested with a small percentage of Indigo users over the next few weeks. \"Our goal is to learn how people …",
    source: "The Verge",
  ...
  },
  {
    ...
    body: "Two critical security flaws in WordPress’ software have given hackers the chance to remotely take over tens of millions of websites, according to an estimate by a cybersecurity researcher.",
    source: "TechCrunch",
  ...
  },
  {
    ...
    body: "Flock Safety sits right at the center of the debate over where the line should be drawn between privacy and public safety. That’s why we’re bringing Flock’s founder and CEO Garrett Langley to the stage to speak about those very issues.",
    source: "TechCrunch",
  ...
  },
  {
    ...
    summary: "The new US central bank chief is reluctant to signal future interest rate moves — how will hedge funds react?",
    body: "The new US central bank chief is reluctant to signal future interest rate moves — how will hedge funds react?",
