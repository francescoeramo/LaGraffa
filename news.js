// Generato automaticamente il 2026-07-19 20:58 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1784494709;
...
const NEWS = [
  {
    id: 1,
    cat: "politica-italiana",
    title: "Via D'Amelio, 34 anni dopo: Mattarella ricorda Borsellino e la scorta, 'simboli di riscossa civile'",
    summary: "Meloni, 'data che ha segnato la storia del Paese'. Alle 16.58 silenzio in via D'Amelio",
    body: "Meloni, 'data che ha segnato la storia del Paese'. Alle 16.58 silenzio in via D'Amelio",
    source: "ANSA",
    url: "https://www.ansa.it/sito/notizie/cronaca/2026/07/18/via-damelio-34-anni-dopo-la-strage-che-continua-a-interrogare-litalia_7a2b8271-7dcd-4fb5-88d6-2719608eeeca.html",
    time: "1 ora fa",
    pub_ts: 1784490565,
    tags: [],
  },
  ...
  },
  {
    ...
    body: "Tamás Sulyok, seen as an Orbán loyalist, had until Saturday night to agree to end his term.",
    source: "BBC World",
  ...
  },
  {
    ...
    body: "Incoming PM Andy Burnham will immediately face foreign policy challenges, including the conflicts in Ukraine and Iran.",
    source: "Al Jazeera",
  ...
  },
  {
    ...
    summary: "At least 50 Malian soldiers were killed after a joint Malian army and Russia's Africa Corps convoy was ambushed.",
    body: "At least 50 Malian soldiers were killed after a joint Malian army and Russia's Africa Corps convoy was ambushed.",
    source: "Al Jazeera",
    url: "https://www.aljazeera.com/video/newsfeed/2026/7/19/at-least-50-malian-soldiers-killed-in-attack-on-military-convoy?traffic_source=rss",
    time: "2 ore fa",
    pub_ts: 1784485678,
    tags: [],
  },
  ...
  },
  {
    ...
    summary: "Decision criticised by oil and gas industry as well as trade union",
    body: "Decision criticised by oil and gas industry as well as trade union",
