// Generato automaticamente il 2026-07-25 13:49 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1784987335;
...
const NEWS = [
  {
    id: 1,
    cat: "politica-italiana",
    title: "Zakharova: 'Crosetto offre un posto a Fedorov? Meglio bin Laden...'",
    summary: "'Peccato, sarebbe stato un eccellente consigliere per il governo italiano'",
    body: "'Peccato, sarebbe stato un eccellente consigliere per il governo italiano'",
    source: "ANSA",
    url: "https://www.ansa.it/sito/notizie/mondo/2026/07/25/zakharova-crosetto-offre-un-posto-a-fedorov-meglio-bin-laden..._e7bc33b0-2bb6-4506-9549-2d10566f73c4.html",
    time: "1 ora fa",
    pub_ts: 1784983042,
    tags: [],
  },
  {
    id: 2,
    cat: "politica-italiana",
    title: "Ranucci intercettato: 'Massoneria e mafia in Rai'. Per FdI 'dichiarazioni gravissime'",
    summary: "I componenti del partito in Vigilanza: 'Denunci o vertici agiscano contro il giornalista'",
    body: "I componenti del partito in Vigilanza: 'Denunci o vertici agiscano contro il giornalista'",
    source: "ANSA",
    url: "https://www.ansa.it/sito/notizie/politica/2026/07/25/ranucci-intercettato-massoneria-e-mafia-in-rai.-per-fdi-dichiarazioni-gravissime_3eb17993-2438-4385-b8f0-bde6c7ff6ef7.html",
    time: "2 ore fa",
    pub_ts: 1784979330,
    tags: [],
  },
  {
    id: 3,
    cat: "politica-italiana",
    title: "Evacuate 250mila persone per gli incendi fra Francia e Spagna",
    summary: "Dopo l'aggiunta degli oltre 60mila evacuati nella regione di Bordeaux",
    body: "Dopo l'aggiunta degli oltre 60mila evacuati nella regione di Bordeaux",
    source: "ANSA",
    url: "https://www.ansa.it/sito/notizie/mondo/2026/07/25/evacuate-250mila-persone-per-gli-incendi-fra-francia-e-spagna_80ab366f-8a73-4a3c-b3bf-1efc3ae4120a.html",
    time: "2 ore fa",
    pub_ts: 1784978405,
    tags: [],
  },
  ...
  },
  {
    ...
    summary: "Iran reports no new US strikes overnight into Saturday for the first time in two weeks.",
    body: "Iran reports no new US strikes overnight into Saturday for the first time in two weeks.",
    source: "Al Jazeera",
