// Generato automaticamente il 2026-07-20 14:22 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1784557302;
...
const NEWS = [
  {
    id: 1,
    cat: "politica-italiana",
    title: "Starmer si è dimesso, Burnham nuovo premier: 'Restituire la stabilità al Paese'",
    summary: "Nel discorso finale da primo ministro promette sostegno al successore: 'Gli lascio un Paese migliore'",
    body: "Nel discorso finale da primo ministro promette sostegno al successore: 'Gli lascio un Paese migliore'",
    source: "ANSA",
    url: "https://www.ansa.it/sito/notizie/mondo/2026/07/20/starmer-si-e-dimesso-burnham-nuovo-premier-restituire-la-stabilita-al-paese_566f5999-9480-49f1-ac8e-185882608aca.html",
    time: "45 min fa",
    pub_ts: 1784554546,
    tags: [],
  },
  ...
  },
  {
    id: 7,
    cat: "geopolitica",
    title: "Jaime Alemán, el primer hombre en recorrer los 193 países de la ONU, los polos y el espacio: “Tanzania es el lugar donde Dios inauguró el mundo”",
    summary: "El exministro, abogado y diplomático panameño, de 72 años, está centrado en una nueva aventura: contar su legado. Ha publicado un libro, produce un documental sobre su vida y quiere conseguir un nuevo récord viajero con su hija",
    body: "Jaime Alemán (Ciudad de Panamá, 72 años) se convirtió en 2020 en el primer hispanoamericano en recorrer los 193 países y los dos Estados observadores reconocidos por la ONU (Palestina y El Vaticano), además de visitar territorios independientes como Kosovo o Taiwán . Completó su travesía por la Tierra en la República de Nauru —un Estado de Micronesia— unos días antes de que las fronteras cerraran por la pandemia.\n\nSu aventura continuó tras el coronavirus; en 2024 recorrió los extremos polares y, el 31 de mayo de 2025, viajó a bordo de la misión NS-32 de Blue Origin , convirtiéndose, cuenta, en el primer hombre en recorrer el mundo entero y el espacio. Al regresar de la línea de Kármán, pensó: “Wow, qué locura, soy el primer humano en lograr esto y encima un latinoamericano. Un panameñito que viene de un país de cuatro millones, con mi pasaporte pequeñito”, cuenta emocionado con la voz y los ojos llorosos.\n\nSeguir leyendo En corto ¿El país con la mejor comida? Francia. Aunque soy feliz con una buena pizza y esas hay en todos lados. ¿Maravilla del mundo favorita? Machu Picchu, en Perú. El destino más romántico es.. . Bora Bora, ahí fue mi luna de miel. ¿Destino al que siempre volvería? Tanzania o Nueva Zelanda. ¿Destino que le falte conocer? La Fosa de las Marianas, la isla Tristán de Acuña o las islas Feroe.",
    source: "El Pais",
    url: "https://elpais.com/elviajero/guia-el-viajero/2026-07-20/jaime-aleman-el-primer-hombre-en-recorrer-los-193-paises-de-la-onu-los-polos-y-el-espacio-tanzania-es-el-lugar-donde-dios-inauguro-el-mundo.html",
    time: "10 ore fa",
    pub_ts: 1784518200,
    tags: [],
  },
  ...
  },
  {
    ...
    body: "Iran praises Spain's win over Argentina after Spanish government's condemnation of policies on Gaza and war on Iran.",
    source: "Al Jazeera",
  ...
  },
  {
    ...
    body: "We explain how the war has changed for all the parties since their MoU unravelled and as the conflict has escalated.",
    source: "Al Jazeera",
  ...
  },
  {
    ...
    body: "For the first time since 2024, StrictlyVC is coming back to New York City — and we're bringing the kind of access you’d expect from an under-wraps event to the whole startup, VC, and dealmaking community.",
    source: "TechCrunch",
  ...
  },
  {
    ...
    body: "On the latest episode of Equity, we debate whether Apple's lawsuit will cast a shadow over OpenAi's much-discussed plans to get into hardware and go public.",
    source: "TechCrunch",
  ...
  },
  {
    ...
    summary: "Regulator fired by Donald Trump says Supreme Court decision is not ‘durable’",
    body: "Regulator fired by Donald Trump says Supreme Court decision is not ‘durable’",
