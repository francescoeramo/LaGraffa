// Generato automaticamente il 2026-07-23 04:20 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1784780400;
...
const NEWS = [
  {
    id: 1,
    cat: "politica-italiana",
    title: "Mario Calabresi valuta una possibile candidatura a sindaco di Milano",
    summary: "Lo ha confermato lo stesso giornalista dopo le indiscrezioni",
    body: "Lo ha confermato lo stesso giornalista dopo le indiscrezioni",
    source: "ANSA",
    url: "https://www.ansa.it/sito/notizie/politica/2026/07/22/mario-calabresi-valuta-una-possibile-candidatura-a-sindaco-di-milano_ada69c87-c839-43a7-8481-c4214470a4bc.html",
    time: "6 ore fa",
    pub_ts: 1784755820,
    tags: [],
  },
  ...
  },
  {
    id: 3,
    cat: "politica-italiana",
    title: "La Giunta dice no ai magistrati su Delmastro, bagarre in Aula",
    summary: "Protesta dei 5 stelle che 'occupano' l'emiciclo del Senato. Conte: 'Lo stanno scudando'",
    body: "Protesta dei 5 stelle che 'occupano' l'emiciclo del Senato. Conte: 'Lo stanno scudando'",
    source: "ANSA",
  ...
  },
  {
    ...
    body: "Canada's dairy supply management system is in the spotlight after the US president singled it out as one of three main irritants used to justify new tariffs.",
    source: "BBC World",
  ...
  },
  {
    ...
    summary: "Bill to fund war on Iran and a handful of Trump priorities passes largely along party lines, faces Senate uncertainty.",
    body: "Bill to fund war on Iran and a handful of Trump priorities passes largely along party lines, faces Senate uncertainty.",
    source: "Al Jazeera",
  ...
  },
  {
    ...
    summary: "US and Iran trade attacks as more explosions are reported in Iranian cities, including Sirik, Ahvaz and Bushehr.",
    body: "US and Iran trade attacks as more explosions are reported in Iranian cities, including Sirik, Ahvaz and Bushehr.",
    source: "Al Jazeera",
  ...
  },
  {
    ...
    body: "Killing of three US soldiers at Jordan base shows Iran maintains the ability to exact deadly toll in grinding conflict.",
    source: "Al Jazeera",
  ...
  },
  {
    ...
    summary: "Early OpenAI backer Khosla Ventures is discussing raising as much as $5.5 billion for its latest set of venture investment funds, a haul that would amount to its largest fundraising event in its two-decade history, according to people familiar with the matter.",
    body: "Early OpenAI backer Khosla Ventures is discussing raising as much as $5.5 billion for its latest set of venture investment funds, a haul that would amount to its largest fundraising event in its two-decade history, according to people familiar with the matter.",
  ...
  },
  {
    id: 20,
    cat: "economia-tech",
    title: "OpenAI Models Spent Hours on Hack That Usually Takes Weeks",
    summary: "When OpenAI’s advanced artificial intelligence models breached AI startup Hugging Face’s internal systems last week, they spent mere hours carrying out a hack that would have taken a skilled human far longer, people familiar with the matter said.",
    body: "When OpenAI’s advanced artificial intelligence models breached AI startup Hugging Face’s internal systems last week, they spent mere hours carrying out a hack that would have taken a skilled human far longer, people familiar with the matter said.",
    source: "Bloomberg Tech",
  ...
  },
  {
    ...
    summary: "PsiBot is raising close to $100 million of funding at a $1.48 billion valuation, joining a growing roster of Chinese AI startups capitalizing on interest in the burgeoning field.",
    body: "PsiBot is raising close to $100 million of funding at a $1.48 billion valuation, joining a growing roster of Chinese AI startups capitalizing on interest in the burgeoning field.",
    source: "Bloomberg Tech",
  ...
  },
  {
    ...
    summary: "Critics warn agreement lacks safeguards to prevent future uranium enrichment and reprocessing",
    body: "Critics warn agreement lacks safeguards to prevent future uranium enrichment and reprocessing",
    source: "Financial Times",
