// Generato automaticamente il 2026-07-19 11:13 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1784459593;
...
const NEWS = [
  {
    id: 1,
    cat: "politica-italiana",
    title: "La Russa: “Spiace per le parole del fratello di Borsellino, ci vuole rispetto per tutti”",
    summary: "“Nessuno può dire cosa farebbe oggi, è come se io dicessi che sarebbe ministro di FdI”",
    body: "“Nessuno può dire cosa farebbe oggi, è come se io dicessi che sarebbe ministro di FdI”",
    source: "ANSA",
  ...
  },
  {
    id: 3,
    cat: "politica-italiana",
    title: "Non si puo' perdere un anno",
    summary: "Legge elettorale, caso Roggero, Ucraina: siamo gia' in campagna elettorale Learn more about your ad choices. Visit megap",
    body: "Legge elettorale, caso Roggero, Ucraina: siamo gia' in campagna elettorale Learn more about your ad choices. Visit megap",
    source: "ANSA",
    url: "https://www.ansa.it/sito/podcast/la_scelta_del_direttore/2026/07/17/non-si-puo-perdere-un-anno_b49f423a-1ac5-454a-ae0f-442bc4bf0245.html",
    time: "5 ore fa",
    pub_ts: 1784439359,
    tags: [],
  },
  ...
  },
  {
    ...
    summary: "One death is reported in what President Zelensky calls \"one of the most massive ballistic attacks\" on Ukraine's capital.",
    body: "One death is reported in what President Zelensky calls \"one of the most massive ballistic attacks\" on Ukraine's capital.",
    source: "BBC World",
  ...
  },
  {
    ...
    summary: "US forces target Iranian sites for the eighth night in a row, while Iran says it fired drones at the US military in Kuwait.",
    body: "US forces target Iranian sites for the eighth night in a row, while Iran says it fired drones at the US military in Kuwait.",
    source: "BBC World",
  ...
  },
  {
    ...
    summary: "Ukraine is particularly vulnerable to ballistic missile attacks due to a shortage of Patriot air defence munitions.",
    body: "Ukraine is particularly vulnerable to ballistic missile attacks due to a shortage of Patriot air defence munitions.",
    source: "Al Jazeera",
    url: "https://www.aljazeera.com/news/2026/7/19/russia-launches-largest-ballistic-missile-attack-on-kyiv-since-start-of-war?traffic_source=rss",
    time: "3 ore fa",
    pub_ts: 1784446088,
    tags: [],
  },
  {
    ...
    summary: "Football fans in Gaza express support for Spain in showdown with Argentina, citing Spanish solidarity with Palestinians.",
    body: "Football fans in Gaza express support for Spain in showdown with Argentina, citing Spanish solidarity with Palestinians.",
    source: "Al Jazeera",
    url: "https://www.aljazeera.com/news/2026/7/19/gaza-cheers-for-spain-as-world-cup-final-anticipation-mounts?traffic_source=rss",
    time: "1 ora fa",
    pub_ts: 1784455765,
    tags: [],
  },
  {
    ...
    summary: "US strikes target Iran's IRGC after two of its soldiers were killed in Jordan, as Tehran attacks Kuwait and Bahrain.",
    body: "US strikes target Iran's IRGC after two of its soldiers were killed in Jordan, as Tehran attacks Kuwait and Bahrain.",
    source: "Al Jazeera",
    url: "https://www.aljazeera.com/news/2026/7/19/us-launches-new-iran-strikes-after-two-soldiers-killed-whats-the-latest?traffic_source=rss",
    time: "2 ore fa",
    pub_ts: 1784450996,
    tags: [],
  },
  ...
  },
  {
    ...
    summary: "Moonshot AI has told investors it’s preparing to list in as early as six months, seizing the opportunity to tap capital markets after its latest model upended industry perceptions of China’s burgeoning capabilities and sent global tech stocks reeling.",
    body: "Moonshot AI has told investors it’s preparing to list in as early as six months, seizing the opportunity to tap capital markets after its latest model upended industry perceptions of China’s burgeoning capabilities and sent global tech stocks reeling.",
  ...
  },
  {
    ...
    summary: "Policymakers expected to prioritise spurring high-tech rather than ‘big bang’ for consumption, analysts say",
    body: "Policymakers expected to prioritise spurring high-tech rather than ‘big bang’ for consumption, analysts say",
    source: "Financial Times",
