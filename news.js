// Generato automaticamente il 2026-07-19 03:32 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1784431904;
...
const NEWS = [
  ...
  },
  {
    ...
    body: "Iran and the US have traded strikes as hostilities re-escalated this week, with Tehran targeting US military facilities across the Gulf region.",
    source: "BBC World",
  ...
  },
  {
    ...
    body: "Palestinians who have endured Israel's genocidal war are still being targeted.",
    source: "Al Jazeera",
  ...
  },
  {
    ...
    summary: "US president says death of soldiers in Jordan a 'sad thing' as US forces attack Iran for the eighth consecutive night.",
    body: "US president says death of soldiers in Jordan a 'sad thing' as US forces attack Iran for the eighth consecutive night.",
    source: "Al Jazeera",
