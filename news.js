// Generato automaticamente il 2026-07-22 06:36 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1784702147;
...
const NEWS = [
  ...
  },
  {
    ...
    body: "The US president's threat to target a key Iranian nuclear site came ahead of the 11th consecutive night of attacks.",
    source: "BBC World",
  ...
  },
  {
    ...
    body: "The Tokyo Metropolitan Government wants workers to ditch the suit and tie for t-shirts, trainers - and shorts.",
    source: "BBC World",
  ...
  },
  {
    ...
    summary: "US Defense Secretary Pete Hegseth gets into a heated exchange after being called a failed leader by Michigan Senator.",
    body: "US Defense Secretary Pete Hegseth gets into a heated exchange after being called a failed leader by Michigan Senator.",
    source: "Al Jazeera",
