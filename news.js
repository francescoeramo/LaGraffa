// Generato automaticamente il 2026-08-02 16:05 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1785686705;
...
const NEWS = [
  {
    id: 1,
    cat: "politica-italiana",
    title: "Bologna ricorda la strage, Meloni: 'Fu terrorismo feroce'. I familiari: 'Dalle sentenze matrice fascista'",
    summary: "Corteo nel capoluogo emiliano, sfilano anche i parenti di Fakir. Il messaggio di Mattarella",
    body: "Corteo nel capoluogo emiliano, sfilano anche i parenti di Fakir. Il messaggio di Mattarella",
    source: "ANSA",
  ...
  },
  {
    ...
    body: "Iran says Trump's comment on pullback from threatened strikes made 'within the context of psychological operations'.",
    source: "Al Jazeera",
  ...
  },
  {
    ...
    summary: "The least bad option for the US is to let the MoU Article 5 play out.",
    body: "The least bad option for the US is to let the MoU Article 5 play out.",
    source: "Al Jazeera",
