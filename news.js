// Generato automaticamente il 2026-08-03 00:03 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1785715374;
...
const NEWS = [
  ...
  },
  {
    ...
    source: "ANSA",
    url: "https://www.ansa.it/sito/notizie/mondo/americalatina/2026/08/02/aereo-si-schianta-in-peru-aveva-problemi-meccanici.-distrutte-due-famiglie-italiane_c83b925c-2fc9-4b66-94bf-b0a73a568502.html",
    time: "4 ore fa",
    pub_ts: 1785698438,
    tags: [],
  },
  ...
  },
  {
    id: 5,
    cat: "geopolitica",
    title: "La nueva fórmula de Trump para rentabilizar la presidencia: Truth Social ofrecerá antes sus mensajes por 100.000 dólares al mes",
    summary: "La red social pone en marcha un servicio de acceso premium a los ‘posts’ del presidente de EE UU, una iniciativa criticada por la oposición y expertos por suponer un uso de información privilegiada",
    body: "La vuelta a la Casa Blanca de Donald Trump se ha convertido en un suculento negocio para su principal interesado. Tan solo la rama de criptomonedas reportó el año pasado al emporio familiar unos ingresos de más de 1.400 millones de dólares. El presidente de Estados Unidos también ha arrancado un acuerdo al IRS -la agencia tributaria, un organismo dependiente de la Administración que él dirige- para evitar que lo auditen a él y a su familia.\n\nPero nada de eso parece bastar. Ahora, su compañía Truth Social ha ideado una nueva forma de ganar dinero: un servicio para aquellos que deseen recibir antes que nadie los mensajes del mandatario, que en muchos casos contienen anuncios de política económica e internacional con evidentes efectos en los mercados. ¿El precio? 100.000 dólares al mes, unos 87.000 euros al cambio actual. Seguir leyendo",
    source: "El Pais",
    url: "https://elpais.com/us/2026-08-02/la-nueva-formula-de-trump-para-rentabilizar-la-presidencia-truth-social-ofrecera-antes-sus-mensajes-por-100000-dolares-al-mes.html",
    time: "2 ore fa",
    pub_ts: 1785707092,
    tags: [],
  },
  ...
  },
  {
    ...
    body: "Tens of thousands of people have been killed in the ongoing war between army chief al-Burhan and RSF commander Dagalo.",
    source: "Al Jazeera",
  ...
  },
  {
    ...
    body: "Tehran's announcement comes after Trump said US would hold off on new Iran attack in hope of quick deal.",
    source: "Al Jazeera",
