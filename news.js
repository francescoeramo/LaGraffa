// Generato automaticamente il 2026-06-12 22:42 UTC da scripts/fetch_news.py
...
const NEWS = [
  ...
  },
  {
    ...
    body: "José Luis Rodríguez Zapatero se ha convertido en una “mina de fragmentación tanto o más dañina que Leire Díez” para el PSOE. La reflexión de uno de los principales secretarios generales autonómicos socialistas tras la tasación de las joyas incautadas al expresidente del Gobierno, valoradas en unos 1,3 millones de euros, coloca a los socialistas “entre la espada y la pared” a la espera de su declaración la próxima semana en la Audiencia Nacional.\n\nZapatero fue imputado inicialmente por tráfico de influencias por el rescate de la aerolínea Plus Ultra, pero el valor de las alhajas con diamantes, zafiros, esmeraldas y rubíes que el referente socialista guardaba en su despacho han llevado al juez José Luis Calama a abrir una pieza separada por delito fiscal y contrabando. “Necesitamos creerle pero a cada día que pasa te surgen más dudas. Lo nuestro es un acto de fe, porque mientras tanto Ferraz no nos dice nada, tan solo nos remite a sus futuras explicaciones”, ironiza un barón territorial después de la gira del papa León XIV.\n\nSeguir leyendo",
    source: "El Pais",
  ...
  },
  {
    id: 11,
    cat: "conflitti",
    title: "Putin admits Ukraine attacks hitting Russian economy, society",
    summary: "Ukraine has increasingly targeted Russian refineries, depots and pipelines, as well as fuel supplies in Crimea.",
    body: "Ukraine has increasingly targeted Russian refineries, depots and pipelines, as well as fuel supplies in Crimea.",
    source: "Al Jazeera",
  ...
  },
  {
    ...
    summary: "An Iran-US deal could provide an opportunity for Gulfs to review their security arrangements.",
    body: "An Iran-US deal could provide an opportunity for Gulfs to review their security arrangements.",
    source: "Al Jazeera",
    url: "https://www.aljazeera.com/news/2026/6/12/how-the-gulf-will-manage-collective-security-after-the-iran-war-ends?traffic_source=rss",
    time: "3 ore fa",
    tags: [],
  },
  {
