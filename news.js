// Generato automaticamente il 2026-07-21 23:03 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1784674967;
...
const NEWS = [
  {
    ...
    summary: "La presidente del Consiglio: 'Verità sulla morte di Fakir'. Schlein: 'Lo Stato ha fallito e proprio lo Stato deve fare piena luce'. Bufera sugli scontri. Lepore: 'Solo una piazza ci rappresenta'.",
    body: "La presidente del Consiglio: 'Verità sulla morte di Fakir'. Schlein: 'Lo Stato ha fallito e proprio lo Stato deve fare piena luce'. Bufera sugli scontri. Lepore: 'Solo una piazza ci rappresenta'.",
    source: "ANSA",
  ...
  },
  {
    id: 6,
    cat: "geopolitica",
    title: "The Iran war could consume the Trump presidency",
  ...
  },
  {
    ...
    summary: "El republicano ordena la vuelta de los “vuelos directos” a Líbano tras recibir a su presidente en la Casa Blanca. Ambos líderes tratan la aplicación del acuerdo de paz con Israel negociado de espaldas a la milicia proiraní",
    body: "El republicano ordena la vuelta de los “vuelos directos” a Líbano tras recibir a su presidente en la Casa Blanca. Ambos líderes tratan la aplicación del acuerdo de paz con Israel negociado de espaldas a la milicia proiraní",
    source: "El Pais",
  ...
  },
  {
    ...
    body: "Newly named Hamas leader al-Hayya faces pressure to cede power amid Gaza's fragile ceasefire.",
    source: "Al Jazeera",
  ...
  },
  {
    ...
    summary: "Replaced military chief Syrskyi clashed with former Defence Minister Fedorov, whose removal last week led to protests.",
    body: "Replaced military chief Syrskyi clashed with former Defence Minister Fedorov, whose removal last week led to protests.",
    source: "Al Jazeera",
  ...
  },
  {
    ...
    body: "Latest cost comes as Hegseth and Joint Chiefs Chairman Caine seek a $1.5 trillion budget, including $70bn for Iran war.",
    source: "Al Jazeera",
  ...
  },
  {
    ...
    summary: "AMG shares tumble after officials question explosive growth of tax-loss harvesting investment techniques",
    body: "AMG shares tumble after officials question explosive growth of tax-loss harvesting investment techniques",
  ...
  },
  {
    ...
    summary: "OpenAI has appointed two financial services executives to its board of directors, drawing on their experience as the company moves toward a Wall Street debut.",
    body: "OpenAI has appointed two financial services executives to its board of directors, drawing on their experience as the company moves toward a Wall Street debut.",
  ...
  },
  {
    id: 22,
    cat: "economia-tech",
    title: "OpenAI Says Its AI Caused Hugging Face Cyber Breach",
    summary: "OpenAI said its artificial intelligence models were able to compromise the internal systems of startup Hugging Face Inc., offering an early glimpse of how AI systems could fuel new cybersecurity threats.",
    body: "OpenAI said its artificial intelligence models were able to compromise the internal systems of startup Hugging Face Inc., offering an early glimpse of how AI systems could fuel new cybersecurity threats.",
    source: "Bloomberg Tech",
  ...
  },
  {
    ...
    summary: "Trading platform Robinhood Markets Inc.’s revenue from prediction market is set to overshadow that from cryptocurrency trading, starting as soon as the second quarter, analysts at Bernstein and Piper Sandler said this week.",
    body: "Trading platform Robinhood Markets Inc.’s revenue from prediction market is set to overshadow that from cryptocurrency trading, starting as soon as the second quarter, analysts at Bernstein and Piper Sandler said this week.",
    source: "Bloomberg Tech",
