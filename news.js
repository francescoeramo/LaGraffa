// Generato automaticamente il 2026-07-20 20:35 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1784579722;
...
const NEWS = [
  ...
  },
  {
    ...
    summary: "The US president spoke just hours after the two warring sides exchanged strikes for the ninth consecutive day.",
    body: "The US president spoke just hours after the two warring sides exchanged strikes for the ninth consecutive day.",
    source: "BBC World",
  ...
  },
  {
    ...
    summary: "Al-Hayya wins Hamas leadership with a single-vote margin, signalling a focus on Gaza amidst continued Israeli aggression",
    body: "Al-Hayya wins Hamas leadership with a single-vote margin, signalling a focus on Gaza amidst continued Israeli aggression",
    source: "Al Jazeera",
  ...
  },
  {
    ...
    body: "Talk of banning Chinese-made open-weight LLMs reveals the challenge of turning AI into a business.",
    source: "TechCrunch",
  ...
  },
  {
    ...
    body: "The one-year-old startup aims to reinvent financial architecture for autonomous AI transactions.",
    source: "TechCrunch",
