// Generato automaticamente il 2026-07-26 00:05 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1785024314;
...
const NEWS = [
  ...
  },
  {
    ...
    summary: "Four other Palestinians were also killed by Israeli air strikes, and a policeman died from wounds sustained last week.",
    body: "Four other Palestinians were also killed by Israeli air strikes, and a policeman died from wounds sustained last week.",
    source: "Al Jazeera",
  ...
  },
  {
    ...
    summary: "Apple wants clearance to buy semiconductors from blacklisted Chinese company amid surging demand from AI",
    body: "Apple wants clearance to buy semiconductors from blacklisted Chinese company amid surging demand from AI",
