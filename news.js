// Generato automaticamente il 2026-08-17 17:32 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1786987943;
const FEED_META = {"successful_sources": 17, "failed_sources": ["Facta", "Valigia Blu"], "total_sources": 19, "total_articles": 33, "full_text_articles": 24};
...
const NEWS = [
  {
    id: "ce92c6cc717d6cfbc60b",
    cat: "politica-italiana",
    title: "Un piccolo comune pugliese chiude il bar dopo 138 anni, ma diventa il ritrovo del paese",
    summary: "Nasce 'ce vedeme o' caffè', uno spazio gestito dalla comunità. Ricalca un progetto francese",
    preview: "Dopo 138 anni, a gennaio scorso, ha chiuso i battenti il bar caffè Basile, uno spazio di socialità per la piccola comunità di Pietramontecorvino, 2350 abitanti, in provincia di Foggia. Da allora, quello che era un luogo animato da persone, sedie, tavolini, dal rumore della macchina da caffè, tra un brusio fatto di voci, convenevoli e risate, all'improvviso si è spento, svuotato. Un vuoto che, da subito, è sembrato pesante e inaccettabile.",
    body: "Dopo 138 anni, a gennaio scorso, ha chiuso i battenti il bar caffè Basile, uno spazio di socialità per la piccola comunità di Pietramontecorvino, 2350 abitanti, in provincia di Foggia. Da allora, quello che era un luogo animato da persone, sedie, tavolini, dal rumore della macchina da caffè, tra un brusio fatto di voci, convenevoli e risate, all'improvviso si è spento, svuotato. Un vuoto che, da subito, è sembrato pesante e inaccettabile. Ecco perché l'associazione 'Dalla parte dei paesi' ha raccolto le richieste di chi non si rassegna a vuoto e silenzio, e si è dato una missione: riaprire, restituire a quello spazio la funzione sociale, aggregativa e conviviale che ha sempre avuto.\n\nl progetto è stato accolto dal comune di Pietramontecorvino e il 25 agosto aprirà 'Ce vedeme o' cafè', ovvero 'ci vediamo al caffè'. Il giorno seguente è prevista già la prima iniziativa, con un incontro in cui si illustrerà il progetto. L'iniziativa si lega idealmente a '1000 bistrot', iniziativa che in Francia sta lavorando alla riapertura dei bar nei piccoli comuni. Quello che riaprirà non sarà un bar, ma un luogo gestito dalla comunità dove poter continuare a sedersi, sorseggiare una bibita, giocare a carte o ai giochi da tavolo, scambiare due chiacchiere, ritrovarsi. Ci saranno arredi, mobili, giochi e libri condivisi, micro attività culturali e una gestione collettiva di uno spazio per sottrarlo al vuoto e al silenzio.\n\nFu Aniello Basile, nel 1888, ad aprire il bar, il primo del paese, capace di diventare un'istituzione. Il suo fondatore, Aniello Basile, ampliò l'offerta. Andò a Napoli per carpire i segreti del gelato, facendo si che nel piccolo comune Foggiano arrivassero anche i gelati artigianali. Gli ultimi a tenere viva l'istituzione del Bar Caffè Basile sono stati Nicola e Lucia.\n\nAdesso, la loro piazzetta è destinata a scrivere e vivere una storia nuova, ma sempre nel segno della comunità.",
    content_status: "full",
    source: "ANSA",
    url: "https://www.ansa.it/puglia/notizie/2026/08/17/in-piccolo-comune-foggiano-bar-chiude-dopo-138-anni-diventa-luogo_e7b99909-34a7-4b46-9d01-8638df0037b4.html",
    time: "2 ore fa",
    pub_ts: 1786980215,
    published_at: "2026-08-17T15:23:35+00:00",
    language: "it",
    score: 1,
  },
  {
    id: "223617fc0f6eb530065c",
    cat: "politica-italiana",
    title: "Lontano da alberi, acqua e metalli: come difendersi dai fulmini",
    summary: "Il vademecum della Protezione Civile. 'Possono colpire anche in assenza di temporale'",
    preview: "Se è in corso un violento temporale con fulmini, cercare subito riparo in un edificio o, se non è possibile, in un'auto ma con finestrini chiusi e l'antenna abbassata. Vanno invece evitati errori come rifugiarsi sotto gli alberi o sostare vicino all'acqua o a cancelli. A chiarire cosa fare per ridurre il rischio di essere colpiti da scariche elettriche, nel momento in cui si registra un aumento di questi fenomeni, è un vademecum pubblicato sul sito del Dipartimento della Protezione Civile.",
    body: "Se è in corso un violento temporale con fulmini, cercare subito riparo in un edificio o, se non è possibile, in un'auto ma con finestrini chiusi e l'antenna abbassata. Vanno invece evitati errori come rifugiarsi sotto gli alberi o sostare vicino all'acqua o a cancelli. A chiarire cosa fare per ridurre il rischio di essere colpiti da scariche elettriche, nel momento in cui si registra un aumento di questi fenomeni, è un vademecum pubblicato sul sito del Dipartimento della Protezione Civile.\n\nCome regolarsi\n\nSe ci sono solo lampi il temporale può essere ancora lontano, ma se si riescono a percepire i tuoni, è a pochi chilometri.\n\nI luoghi comuni da sfatare\n\nQuello che meno si sa è che i fulmini non si manifestano solo in presenza di un rovescio ma \"possono colpire ad alcuni chilometri di distanza dalla perturbazione\". Il metallo non attira la scarica: \"non è quindi pericoloso tenere in mano piccoli oggetti metallici\" come orologio o chiavi, ma è un buon conduttore di elettricità quindi bisogna \"restare lontani da oggetti metallici estesi come recinzioni e ringhiere perché, se colpiti, conducono la corrente a chi vi si trova a contatto\".\n\nQuali sono i luoghi più rischiosi\n\nLa montagna è il luogo più a rischio, ma lo sono anche tutti i luoghi ampi ed esposti, come un prato, soprattutto in presenza dell'acqua. I bersagli privilegiati sono quelli alti o sporgenti (anche una persona in un prato) e quelli di forma appuntita.\n\nQuindi, se ci si trova all'aperto, tenersi lontani da pali o alberi. Se si è in vetta scendere di quota, evitando creste e tenendosi alla larga funi o scale metalliche: meglio camminare lungo avvallamenti del terreno. Se si è insieme ad altre persone, procedere a distanza di almeno 10 metri gli uni dagli altri.\n\nPer chi è al mare o al lago\n\nAl mare o al lago, evitare vicinanza con l'acqua perché la corrente si può trasmettere fino ad alcune decine di metri. In luoghi ampi e piatti, come le spiagge, si è più esposti.\n\nLiberarsi di ombrelli, ombrelloni o canne da pesca e non sdraiarsi ma restare in piedi uniti, rendendo minimo il punto di contatto con il suolo, per ridurre l'intensità dell'eventuale scarica.\n\nCosa fare in campeggio\n\nPer chi si trova in camping, durante il temporale, è bene ripararsi in una struttura in muratura o, in mancanza, all'interno dell'automobile. Non cercare riparo in roulotte o camper e se si è in tenda evitare di toccare le pareti, isolandosi dal terreno con materassini o zaini.\n\nLe buone regole anche a casa\n\nIn casa, infine, staccare la spina dagli apparecchi ad alimentazione elettrica e mantenersi a distanza da porte e finestre, assicurandosi che queste ultime siano chiuse.",
    content_status: "full",
    source: "ANSA",
    url: "https://www.ansa.it/canale_saluteebenessere/notizie/sanita/2026/08/17/lontano-da-alberi-acqua-e-metalli-come-difendersi-dai-fulmini_cab21846-0d19-490c-8de0-983813078034.html",
    time: "2 ore fa",
    pub_ts: 1786978357,
    published_at: "2026-08-17T14:52:37+00:00",
    language: "it",
    score: 1,
  },
  {
  ...
  {
    id: "0cea6748d85cab4ba6dd",
    cat: "geopolitica",
    title: "Trump amenaza ahora con bombardear Omán si “se interpone” en su camino",
    summary: "El presidente estadounidense insiste en que su objetivo número uno es que Irán no consiga el arma nuclear",
    preview: "Ahora, Omán. Con el alto el fuego con Irán a punto de vencer, el presidente de Estados Unidos, Donald Trump, ha apuntado este lunes directamente a ese país si no se aviene a aceptar sus exigencias en torno al estrecho de Ormuz. “Si se interpone en nuestro camino, les bombardearemos sin piedad”, ha anunciado en una entrevista telefónica con un reportero de su cadena de televisión predilecta, Fox News, según ha contado el propio periodista, Trey Yingst. Seguir leyendo",
    body: "Ahora, Omán. Con el alto el fuego con Irán a punto de vencer, el presidente de Estados Unidos, Donald Trump, ha apuntado este lunes directamente a ese país si no se aviene a aceptar sus exigencias en torno al estrecho de Ormuz. “Si se interpone en nuestro camino, les bombardearemos sin piedad”, ha anunciado en una entrevista telefónica con un reportero de su cadena de televisión predilecta, Fox News, según ha contado el propio periodista, Trey Yingst.\n\nSeguir leyendo",
    content_status: "feed",
    source: "El Pais",
    url: "https://elpais.com/internacional/2026-08-17/trump-amenaza-ahora-con-bombardear-oman-si-se-interpone-en-su-camino.html",
    time: "5 ore fa",
    pub_ts: 1786966915,
    published_at: "2026-08-17T11:41:55+00:00",
    language: "es",
    score: 1,
  },
  {
    ...
    cat: "geopolitica",
    title: "El presidente de Ceuta eleva el tono contra el Gobierno y amenaza con acudir a la justicia si no resuelve la crisis: “Hay pasividad absoluta”",
    summary: "Juan Jesús Vivas se niega a ceder emplazamientos céntricos para realojar migrantes alegando quejas de los “vecinos”",
    ...
    body: "El presidente de Ceuta, Juan Jesús Vivas , lleva más de 25 años al frente del bastón de mando de la ciudad autónoma. Del Partido Popular, es un dirigente que siempre ha mantenido relaciones cordiales con los distintos Gobiernos centrales a lo largo de todas las legislaturas, también con el de Pedro Sánchez, incluso tras la entrada masiva del 31 de julio. Desde entonces, Vivas ha ido elevando poco a poco el tono de los ataques, hasta cambiar drásticamente su discurso este lunes.\n\nEn una comparecencia extraordinaria, ha censurado la “pasividad casi absoluta” tras la crisis de La Moncloa, ha acusado veladamente a Sánchez de querer ceder la soberanía a Marruecos y ha amenazado con recurrir al “poder judicial” si la situación no cambia. Vivas también se opone a ceder emplazamientos para el realojo de personas migrantes solicitados por el Gobierno alegando que hay “quejas” de los vecinos, porque algunos de los lugares están en zonas céntricas.\n\nTampoco quiere que se habilite el puerto para la acogida. Seguir leyendo",
    content_status: "feed",
    source: "El Pais",
  ...
  },
  {
    ...
    time: "25 min fa",
    pub_ts: 1786986449,
    published_at: "2026-08-17T17:07:29+00:00",
    language: "en",
    score: 1,
  },
  {
    id: "cb879429eb202ab1c78a",
    cat: "conflitti",
  ...
  },
  {
    ...
    time: "4 ore fa",
    pub_ts: 1786971951,
    published_at: "2026-08-17T13:05:51+00:00",
    language: "es",
    score: 1,
  },
  {
    id: "e09a17c4e4f3f8e415c9",
    cat: "ai",
  ...
  {
    id: "b28c9006be7c3b902343",
    cat: "economia-tech",
    title: "Andreessen Horowitz Focus of DOJ Probe Over Board Directors",
    summary: "Venture capital firm Andreessen Horowitz is the focus of a Justice Department antitrust probe over whether its investment partners are improperly serving on the boards of competing artificial intelligence companies, according to people familiar with the matter.",
    preview: "Venture capital firm Andreessen Horowitz is the focus of a Justice Department antitrust probe over whether its investment partners are improperly serving on the boards of competing artificial intelligence companies, according to people familiar with the matter.",
    body: "Venture capital firm Andreessen Horowitz is the focus of a Justice Department antitrust probe over whether its investment partners are improperly serving on the boards of competing artificial intelligence companies, according to people familiar with the matter.",
    content_status: "feed",
    source: "Bloomberg Tech",
    url: "https://www.bloomberg.com/news/articles/2026-08-17/andreessen-horowitz-focus-of-doj-probe-over-board-directors",
    time: "19 min fa",
    pub_ts: 1786986830,
    published_at: "2026-08-17T17:13:50+00:00",
    language: "en",
    score: 1,
  },
  {
    id: "b9c7bc81ba26bdad67c6",
    cat: "economia-tech",
    title: "US tech stock correction likely, warn ECB economists",
    summary: "Boom-bust pattern could become ‘question of financial stability’ for euro area, central bank team writes in blog post",
    preview: "Subscribe to unlock this article Try unlimited access Only $1 for 4 weeks Then $75 per month. Complete digital access to quality FT journalism on any device. Cancel anytime during your trial. Explore more offers. Standard Digital $45 per month Essential digital access to quality FT journalism on any device. Pay a year upfront and save 20%. Premium Digital Complete coverage $75 per month Complete digital access to quality FT journalism with expert analysis from industry leaders. Pay a year upfront and save 20%.",
    body: "Subscribe to unlock this article\n\nTry unlimited access\n\nOnly $1 for 4 weeks\n\nThen $75 per month. Complete digital access to quality FT journalism on any device. Cancel anytime during your trial.\n\nExplore more offers.\n\nStandard Digital\n\n$45 per month\n\nEssential digital access to quality FT journalism on any device. Pay a year upfront and save 20%.\n\nPremium Digital\n\nComplete coverage\n\n$75 per month\n\nComplete digital access to quality FT journalism with expert analysis from industry leaders. Pay a year upfront and save 20%.\n\nFT Digital Edition\n\n$16.99 per month\n\nOur digitised version of the FT newspaper, for easy reading on any device.\n\nCheck whether you already have access via your university or organisation.\n\nTerms & Conditions apply\n\nExplore our full range of subscriptions.\n\nFor individuals\n\nDiscover all the plans currently available in your country\n\nFor multiple readers\n\nDigital access for organisations. Includes exclusive features and content.",
    content_status: "full",
    source: "Financial Times",
    url: "https://www.ft.com/content/cb4b22ab-4183-4d19-be60-6d2fab86d86d?syn-25a6b1a6=1",
    time: "2 ore fa",
    pub_ts: 1786977625,
    published_at: "2026-08-17T14:40:25+00:00",
    language: "en",
    score: 1,
  },
  {
    id: "a562c58303369b7b1560",
    cat: "economia-tech",
    title: "Summer Books of Fintech Execs: From Dickens to Market Panics",
    summary: "Looking for your next summer read? We asked leaders across digital finance for their recommendations. From 19th-century financial panic to reimagined Charles Dickens, here are the books they think are worth packing on vacation.",
    preview: "Looking for your next summer read? We asked leaders across digital finance for their recommendations. From 19th-century financial panic to reimagined Charles Dickens, here are the books they think are worth packing on vacation.",
    body: "Looking for your next summer read? We asked leaders across digital finance for their recommendations. From 19th-century financial panic to reimagined Charles Dickens, here are the books they think are worth packing on vacation.",
    content_status: "feed",
    source: "Bloomberg Tech",
    url: "https://www.bloomberg.com/news/articles/2026-08-17/from-dickens-to-market-panics-the-summer-books-of-fintech-execs",
    time: "5 ore fa",
    pub_ts: 1786968000,
  ...
  {
    id: "f6e7711d8beaacce5dd9",
    cat: "economia-tech",
    title: "Il primo specchio bugiardo, riflette immagini diverse dall'originale",
    summary: "Trasforma un 1 in 8 o un cappello in una borsa, in futuro potrà nascondere oggetti",
    preview: "Ottenuto il primo specchio bugiardo, che riflette un’immagine diversa da quella che ha davanti. E’ possibile grazie a nuovi materiali che per la loro struttura possono manipolare la luce in arrivo e restituirla in modo differente, secondo un programma.. A svilupparlo è la ricerca pubblicata sulla rivista Nature Communications e coordinata da Aydogan Ozcan, dell’Università della California a Los Angeles. Gli specchi finora noti riflettono l’immagine che hanno di fronte, a volte possono deformarla ma si tratta comunque della stessa immagine iniziale.",
    body: "Ottenuto il primo specchio bugiardo, che riflette un’immagine diversa da quella che ha davanti. E’ possibile grazie a nuovi materiali che per la loro struttura possono manipolare la luce in arrivo e restituirla in modo differente, secondo un programma.. A svilupparlo è la ricerca pubblicata sulla rivista Nature Communications e coordinata da Aydogan Ozcan, dell’Università della California a Los Angeles.\n\nGli specchi finora noti riflettono l’immagine che hanno di fronte, a volte possono deformarla ma si tratta comunque della stessa immagine iniziale. Gli specchi bugiardi, invece, mostrano immagini totalmente diverse da quelle che hanno davanti. Per esempio, un cappello o una sciarpa possono diventare una borsa. Quel che può sembrare un comportamento magico in realtà è il rsultato di una sofisticata tecnica di costruzione dello specchio, tale da modificare la luce che vi rimbalza fino a mostrare un'immagine completamente differente dall'originale.\n\nLa chiave di tutto è nella disposizione delle microscopiche componenti dello specchio, che possono essere configurate in modo da trasformare la luce in ingresso e restituirla in modo preprogrammato. Al momento è possibile preimpostare solo singole immagini ma in futuro, dicono i ricercatori, sarà possibile far comparire più immagini riflesse in base all’oggetto che si prova davanti.",
    content_status: "full",
    source: "ANSA",
    url: "https://www.ansa.it/canale_scienza/notizie/frontiere/2026/08/17/il-primo-specchio-bugiardo-riflette-immagini-diverse-dalloriginale_c9aaf7de-8be4-4626-bad9-2334cf3f0f04.html",
    time: "12 ore fa",
    pub_ts: 1786944534,
    published_at: "2026-08-17T05:28:54+00:00",
    language: "it",
    score: 1,
  },
  {
