// Generato automaticamente il 2026-07-18 17:03 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1784394170;
...
const NEWS = [
  {
    id: 1,
    cat: "politica-italiana",
    title: "Cuba in ginocchio, blackout e proteste spaventano il regime",
    summary: "Raddoppiato il prezzo del gas, il governo teme un'esplosione sociale",
    body: "Raddoppiato il prezzo del gas, il governo teme un'esplosione sociale",
    source: "ANSA",
    url: "https://www.ansa.it/sito/notizie/mondo/2026/07/18/cuba-in-ginocchio-blackout-e-proteste-spaventano-il-regime_e9c777b0-3165-48b4-9544-1860ea48bdb1.html",
    time: "17 min fa",
    pub_ts: 1784393131,
    tags: [],
  },
  {
    id: 2,
    cat: "politica-italiana",
    title: "Bimba di 4 anni annega in una piscina di un hotel di Milano Marittima",
    summary: "Il padrer si sarebbe assentato per andare in camera e lei in quel frangente sarebbe finita in acqua",
    body: "Il padrer si sarebbe assentato per andare in camera e lei in quel frangente sarebbe finita in acqua",
    source: "ANSA",
    url: "https://www.ansa.it/sito/notizie/cronaca/2026/07/18/bimba-di-4-anni-annega-in-una-piscina-di-un-hotel-di-milano-marittima_3677e745-331e-4580-89ce-2c9c049d53f7.html",
    time: "17 min fa",
    pub_ts: 1784393126,
    tags: [],
  },
  {
    ...
    summary: "Il sindaco di New York: 'Il premier israeliano criminale di guerra, va processato all'Aja'. Ben Gvir vuole i coccodrilli attorno alle carceri con detenuti palestinesi",
    body: "Il sindaco di New York: 'Il premier israeliano criminale di guerra, va processato all'Aja'. Ben Gvir vuole i coccodrilli attorno alle carceri con detenuti palestinesi",
    source: "ANSA",
  ...
  },
  {
    ...
    body: "Mali says counterattack under way as rebels claim they inflicted 'human losses' and 'material damage' on troops.",
    source: "Al Jazeera",
    url: "https://www.aljazeera.com/news/2026/7/18/armed-groups-attack-malian-military-convoy-in-gao-region?traffic_source=rss",
    time: "38 min fa",
    pub_ts: 1784391869,
    tags: [],
  },
  {
    id: 13,
    cat: "conflitti",
    title: "Iran suggests MoU ‘suspended’ amid reports 50 killed in US strikes in July",
    ...
    body: "Conflict has been escalating since US President Donald Trump declared 10 days ago that peace deal with Iran was over.",
    source: "Al Jazeera",
