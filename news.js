// Generato automaticamente il 2026-08-02 10:03 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1785664982;
...
const NEWS = [
  ...
  },
  {
    id: 4,
    cat: "geopolitica",
    title: "Donald Trump dice que suspende los ataques contra Irán a la espera de un acuerdo rápido",
    summary: "El presidente de EE UU asegura haber tomado la decisión a petición de Teherán y de otros países de la región",
    body: "El presidente de Estados Unidos, Donald Trump, ha afirmado este sábado por la noche que su país aplazará un nuevo ataque contra Irán siempre que pueda alcanzarse rápidamente un acuerdo que detenga las ambiciones nucleares iraníes y permita reabrir el estrecho de Ormuz. Seguir leyendo",
    source: "El Pais",
  ...
  },
  {
    id: 10,
    cat: "conflitti",
    title: "Iran war live: Trump cancels attack, calls for a ‘rapid’ deal on Hormuz",
