// Generato automaticamente il 2026-08-01 07:31 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1785569469;
...
const NEWS = [
  {
    id: 1,
    cat: "politica-italiana",
    title: "Iran: 'Pronto il piano per rispondere alla follia Usa'. Petroliera colpita nello Stretto di Hormutz",
    summary: "'Include le infrastrutture vitali del regime sionista e le infrastrutture energetiche statunitensi nella regione'",
    body: "'Include le infrastrutture vitali del regime sionista e le infrastrutture energetiche statunitensi nella regione'",
    source: "ANSA",
    url: "https://www.ansa.it/sito/notizie/mondo/2026/08/01/iran-pronto-il-piano-per-rispondere-alla-follia-usa.-petroliera-nello_11b7abfc-4279-494d-815e-907b7b2849cb.html",
    time: "1 ora fa",
    pub_ts: 1785565366,
    tags: [],
  },
  ...
  },
  {
    ...
    body: "Football's world governing body Fifa abandons plans to sell off stakes in its major competitions after widespread opposition to president Gianni Infantino's proposal.",
    source: "BBC World",
  ...
  },
  {
    ...
    summary: "Residents trapped as partially collapsed buildings catch fire after deadly strike on Ukrainian capital.",
    body: "Residents trapped as partially collapsed buildings catch fire after deadly strike on Ukrainian capital.",
    source: "Al Jazeera",
